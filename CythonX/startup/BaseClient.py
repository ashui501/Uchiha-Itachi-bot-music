...
class UltroidClient(TelegramClient):
    ...
    def __repr__(self):
        return "<CɪᴘʜᴇʀX ᴇxᴄlusivᴇ ʙᴏᴛ Client :\n self: {}\n bot: {}\n>".format(
    ...
    async def fast_uploader(self, file, **kwargs):
        ...
        from CythonX.fns.FastTelethon import upload_file
        from CythonX.fns.helper import progress
    ...
    async def fast_downloader(self, file, **kwargs):
        ...
        from CythonX.fns.FastTelethon import download_file
        from CythonX.fns.helper import progress
