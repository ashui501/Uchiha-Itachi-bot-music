...
•`{i}addclean`
    Clean all Upcoming action messages in added chat like someone joined/left/pin etc.

•`{i}rmclean`
    Remove chat from database.

•`{i}listclean`
   To get list of all chats where it's activated.
