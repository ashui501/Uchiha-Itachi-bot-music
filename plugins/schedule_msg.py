...
•`{i}schedule <text/reply to msg> <time>`
    In time you can use second as number, or like 1h or 1m
    eg. `{i}schedule Hello 100` It deliver message after 100 sec.
    eg. `{i}schedule Hello 1h` It deliver message after an hour.
"""
...
async def _(e):
    ...
    if x and not xx:
        ...
        if y.isdigit():
            ...
            await eod(e, "`Scheduled message Succesfully`")
        else:
            try:
