...
# logging in
try:
    with TelegramClient(StringSession(), API_ID, API_HASH) as cipherx:
        print("Generating a user session for CipherX Bot...")
        ult = cipherx.send_message(
            "me",
            f"**CIPHERX** `SESSION`:\n\n`{cipherx.session.save()}`\n\n**Do not share this anywhere!**",
        )
