...
#   / ____(_)___  / /_  ___  ____| |/ /   \ \   / / ___|    #
#  / /   / / __ \/ __ \/ _ \/ ___/   /     \ \ / / |        #
# / /___/ / /_/ / / / /  __/ /  /   |       \ V /| |___     #
# \____/_/ .___/_/ /_/\___/_/  /_/|_|        \_/  \____|    #
#       /_/                                                 #
#-----------------------------------------------------------#
...
from cython import HNDLR, LOGS, asst, udB, vcClient
...
from cython.functions.tools import is_url_ok
from cython.functions.ytdl import get_videos_link
from cython.functions.info import get_user_id
from cython.dB.vc_group import check_vcauth, get_chats as get_vc
from cython.misc import owner_and_sudos, sudoers
from cython.misc._assistant import in_pattern
        ...
        try:
            await vcClient(
                functions.phone.CreateGroupCallRequest(
                    self._chat, title="🎧 CɪᴘʜᴇʀX Ⲉⲭⲥⳑυⲋⲓⳳⲉ ⲃⲟⲧ Music 🎶"
                )
            )
