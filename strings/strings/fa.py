...
com_2: "`در حال جستجو...`"
# help 
help_1: "`{}` یک پلاگین معتبر نیست!"
help_2: "بات به عبارت اینلاین پاسخ نمی دهد.\nبات را ری استارت کنید `{}restart`"
help_3: "`لطفا اینلاین مود بات خود را فعال نمایید.` @Botfather."
help_4: "سلام, \nشما در بات مود هستید. \nکاربران بات مود نمی توانند منوی هلپ را مستقیما دریافت کنند... \nبه جای آن کپی پیست کنید این کامند را و بر روی پاپ آپ بزنید.\n\n `@{} ultd`"

# autopic
autopic_1: "سلام, متنی بدهید به من ..."
autopic_2: "هیچ نتیجه ای یافت نشد برای `{}`"
autopic_3: "یک مجموعه `{}` مرتبط با سرچ شما یافت شد!\nشروع تغییر خودکار پروفایل!"

# inline
inline_1: "[CɪᴘʜᴇʀX Bᴏᴛ Sᴜᴘᴘᴏʀᴛ](t.me/FutureTechnologyGuardX)\n\n
**منوی هلپ {}.\n\n
Pʟᴜɢɪɴs ~ {}**"
inline_2: "[CɪᴘʜᴇʀX Bᴏᴛ Sᴜᴘᴘᴏʀᴛ](t.me/FutureTechnologyGuardX)\n\n
**منوی هلپ {}.\n\n
Aᴅᴅᴏɴs ~ {}**"
inline_3: "[CɪᴘʜᴇʀX Bᴏᴛ Sᴜᴘᴘᴏʀᴛ](t.me/FutureTechnologyGuardX)\n\n
**منوی هلپ {}.\n\n
Aᴅᴅᴏɴs ~ {}\n\n
...
# afk
afk_1: "`No Longer Offline\n\n
Was away for ~ {}`"
afk_2: "#Offline Mode\n
Set Offline mode to False.\n
Was Offline for {}`"
afk_3: "I'm currently Offline.\n
Last seen {} ago.`\n\n
**Reason:** `{}`"
afk_4: "`I'm currently Offline.\n\n
Last seen {} ago.`"
afk_5: "`Going Offline.`\n\n
**Reason:** `{}`"
afk_6: "I'm going Offline."
afk_7: "Currently Offline with reason {}"
afk_8: "Currently Offline."

# bot
alive_1: "**CɪᴘʜᴇʀX Suᴩᴇr Tᴇᴄhnᴏlᴏgy Bᴏᴛ**
**{}**
✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵✵
...
║┣⪼ **✨ CɪᴘʜᴇʀX ⲓⲋ ⲧⲏⲉ ⲃⲉⲋⲧ ✨**
║╰━━━━━━━━━━━━━━━➣ ╚══════════════════❍⊱❁۪۪۪"
log: "CɪᴘʜᴇʀX Suᴩᴇr Tᴇᴄhnᴏlᴏgy Bᴏᴛ Logs.\nPasted [here]({}) too!"
ping: "**█▀█ █ █▄░█ █▀▀ █ \n█▀▀ █ █░▀█ █▄█ ▄**\n\n**➲ CɪᴘʜᴇʀX Ⲋⲉʀⳳⲉʀ Ⲣⲓⲛⳋ** - `{}ms`\n\n**➲ CɪᴘʜᴇʀX Bᴏᴛ Ⳙⲣⲧⲓⲙⲉ** - `{}`"
usage: "`Dyno usage for`  **CɪᴘʜᴇʀX Bᴏᴛ**:\n\n
 -> `Dyno usage for`  **{}**:\n
     •  `{}`**h**  `{}`**m**
**|**  [`{}`**%**]\n\n
 -> `Dyno usage for`  **CɪᴘʜᴇʀX Bᴏᴛ**:\n
     •  `{}`**h**  `{}`**m**
**|**  [`{}`**%**]\n\n
**Total Disk Space: {}\n\n**
**Used: {}  Free: {}\n\n**
...
# chats
chats_1: "`Processing...`"
chats_2: "`Can't delete this chat`"
chats_3: "`I'm not an admin`"
chats_4: "#Deleted\nDeleted {}"
chats_5: "Your [{}]({}) Group Made Boss!"
chats_6: "Join @FutureTechnologyGuardX"
...
sf_21: "\n\nFedInfo Extracted by CɪᴘʜᴇʀX Suᴩᴇr Tᴇᴄhnᴏlᴏgy Bᴏᴛ"

# gdrive
gdrive_1: "`You have already authorized with Google Drive`"
...
gdrive_4: "`Something went wrong! Send `/auth` again.\nIf same happens contact `@CipherXBot"
gdrive_5: "`Success!\nYou are all set to use Google Drive with CɪᴘʜᴇʀX Suᴩᴇr Tᴇᴄhnᴏlᴏgy Bᴏᴛ.`"
...
pmperm_3: "Reply to someone's message or try this commmand in private."
